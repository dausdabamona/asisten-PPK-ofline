"""
Script untuk membuat template Lembar Permintaan (LBR_REQ).
- Format Word (.docx)
- Spasi 1 (single spacing)
- Tabel rincian dengan kolom nomor sempit
"""
...
def create_lembar_permintaan_template():
    ...
    run_title = title.add_run("LEMBAR PERMINTAAN PENCAIRAN DANA")
    run_title.bold = True
    ...
    rincian_title.add_run("Rincian Permintaan:")
    ...
    # Data row template (placeholder for rincian items)
    ...
    ttd_intro.add_run("Demikian permintaan ini disampaikan untuk dapat diproses lebih lanjut.")
    ...
    # Header - jabatan
    ttd_table.cell(0, 0).text = "Yang Mengajukan,"
    ttd_table.cell(0, 1).text = "Menyetujui,\nPejabat Pembuat Komitmen"
    ...
    print(f"Lembar Permintaan template saved to: {output_path}")
    return output_path


if __name__ == "__main__":
    create_lembar_permintaan_template()
    print("\nTemplate Lembar Permintaan berhasil dibuat!")
